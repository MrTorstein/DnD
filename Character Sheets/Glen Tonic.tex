...
Will favorise Heldarion over Sam(dead). Don't remember why. \\
...
\textbf{Hit dice available:}	& 3/5 (d6)					\\
...
\tabtabitem Recover 1d2 charges every dawn \\
\tabitem Morningstar (not proficient) 1d8 damage
		\end{tabularx}
...
2 x Potion of Healing \dotfill				& 0.25	\\
Staff of the Rat King \dotfill				& 2		\\
4 x Canisters of oil						&		\\
Scroll with	Darkvision(Don't) and Grease	&		\\
...
2 x Morningstars							& 2		\\
A Sword the shines and can't be given away	&		\\
	\end{tabularx}
	\begin{tabularx}{\textwidth}{X|r}
Spellbook with								& 1.5	\\
